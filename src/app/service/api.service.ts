...
export class ApiService {
  ...
  apiUrl = 'https://unimartpasabuyapi.onrender.com/api';
  baseUrl = 'https://unimartpasabuyapi.onrender.com/user';
  ...
  deleteItem(order_id: any, product_id: any) {
    return this.http.delete(
      `${this.apiUrl}/deleteItemOrder/${order_id}/${product_id}`
    );
  }

  addQuantity(order_id: any, product_id: any) {
    return this.http.put(
      `${this.apiUrl}/addQuantity/${order_id}/${product_id}`,
      {}
    );
  }
  ...
  subtractQuantity(order_id: any, product_id: any) {
    return this.http.put(
      `${this.apiUrl}/minusQuantity/${order_id}/${product_id}`,
      {}
    );
  }
